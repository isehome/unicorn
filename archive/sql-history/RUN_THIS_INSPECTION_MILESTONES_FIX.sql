-- ============================================
-- COMPREHENSIVE INSPECTION MILESTONES FIX
-- ============================================
-- This migration:
-- 1. Adds rough_in_inspection and final_inspection to allowed milestone types
-- 2. Fixes check_milestone_completion function to handle inspection milestones
-- 3. Adds ELSE clause to prevent CASE statement errors
-- ============================================

-- STEP 1: Update CHECK constraint to allow inspection milestone types
DO $$
BEGIN
  ...
  RAISE NOTICE '✅ Step 1: Updated CHECK constraint with inspection milestone types';
END $$;

-- STEP 2: Update check_milestone_completion function
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ INSPECTION MILESTONES FIX COMPLETE';
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'Changes applied:';
  RAISE NOTICE '  1. ✅ Added rough_in_inspection to allowed milestone types';
  RAISE NOTICE '  2. ✅ Added final_inspection to allowed milestone types';
  RAISE NOTICE '  3. ✅ Added rough_in_inspection logic to check_milestone_completion';
  RAISE NOTICE '  4. ✅ Added final_inspection logic to check_milestone_completion';
  RAISE NOTICE '  5. ✅ Added ELSE clause to prevent CASE statement errors';
  RAISE NOTICE '';
  RAISE NOTICE 'Milestone types now available:';
