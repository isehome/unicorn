-- =====================================================
-- UPDATE MILESTONE PERCENTAGES VIEW - PARTS BASED
-- =====================================================
-- Updates the materialized view to use NEW parts-based calculation
-- - Counts parts (quantity) not line items
-- - Includes inventory on hand (quantity_on_hand from global_parts)
-- - Only counts SUBMITTED POs (excludes drafts)
-- =====================================================
...
SELECT 'Milestone percentages view updated to use parts-based calculation!' as status;
