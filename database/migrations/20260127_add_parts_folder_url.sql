-- Add parts_folder_sharepoint_url column for direct folder access
-- This allows users to click through to the SharePoint folder containing all documentation

ALTER TABLE global_parts ADD COLUMN IF NOT EXISTS parts_folder_sharepoint_url text;

COMMENT ON COLUMN global_parts.parts_folder_sharepoint_url IS 'SharePoint URL for the part documentation folder (Parts/Manufacturer/PartNumber)';

-- Update the save_parts_enrichment function to handle this new field
