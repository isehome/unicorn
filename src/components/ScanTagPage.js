...
const ScanTagPage = () => {
  ...
  return (
    <div className="min-h-screen pb-24 bg-gray-50 dark:bg-zinc-900 transition-colors">
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        <div className="rounded-2xl overflow-hidden" style={sectionStyles.card}>
          <div className="p-6 space-y-4">
            ...
            <div className="rounded-xl border border-dashed border-violet-200 dark:border-violet-700 overflow-hidden bg-white dark:bg-zinc-800">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-zinc-800 py-2.5 pl-9 pr-3 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-violet-500"
                  />
                </div>
                <Button
                  type="submit"
