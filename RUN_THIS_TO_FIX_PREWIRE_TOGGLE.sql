-- ================================================================
-- FIX FOR PREWIRE TOGGLE NOT SAVING
-- ================================================================
-- This creates an RPC function that bypasses RLS to update the
-- required_for_prewire field. Run this in Supabase SQL Editor.
-- ================================================================
...
COMMENT ON FUNCTION public.update_part_prewire_status IS
  'Updates the required_for_prewire flag for a part. Uses SECURITY DEFINER to bypass RLS issues.';
...
-- ================================================================
-- END OF SCRIPT
-- After running this, refresh your app and try toggling the switch
-- ================================================================
